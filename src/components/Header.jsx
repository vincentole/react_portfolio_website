            ...
            <div className='container-cstm md:flex md:items-center md:justify-between'>
                ...
                <nav className='max-h-0 md:h-full md:flex md:space-x-10 transition-all duration-500 ease-in-out'>
                    ...
                    <ul className='space-y-4 md:flex md:items-center md:space-y-0 md:space-x-8'>
                        <li>
                            <a className='group' href='#about'>
                                <span className='nav-item-last-span'>about</span>()
                            </a>
                        </li>
                        <li>
                            <a className='group' href='#portfolio'>
                                <span className='text-primary-yellow'>Portfolio</span>.<span className='nav-item-last-span'>show</span>()
                            </a>
                        </li>
                        <li>
                            <a className='group' href='#contact'>
                                <span className='nav-item-last-span'>contact</span>()
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul className='social-nav items-center md:py-0'>
                        <li>
                            <a className='' target='_blank' href='https://github.com/vincentole' aria-label='Visite my GitHub Profile' rel='noopener noreferrer'>
                        ...
                        <li>
                            <a target='_blank' href='https://www.linkedin.com/in/ole-urfels/' aria-label='Visite my LinkedIn Profile' rel='noopener noreferrer'>
