        ...
        <section id='portfolio' className='section'>
            ...
            <div className='container-cstm'>
                ...
                <div id='projects' className='grid grid-col-1 md:grid-cols-2 gap-2'>
                    <Project title={pfData[0].title} description={pfData[0].description} code={pfData[0].code} layout={pfData[0].layout} githubLink={pfData[0].liveLink} liveLink={pfData[0].liveLink} bgDefaultClass={pfData[0].bgDefaultClass} bgSquareClass={pfData[0].bgSquareClass} />
                    <DescriptionMobile title={pfData[0].title} description={pfData[0].description} code={pfData[0].code} layout={pfData[0].layout} githubLink={pfData[0].liveLink} liveLink={pfData[0].liveLink} />
                    <Project title={pfData[1].title} description={pfData[1].description} code={pfData[1].code} layout={pfData[1].layout} githubLink={pfData[1].liveLink} liveLink={pfData[1].liveLink} bgDefaultClass={pfData[1].bgDefaultClass} bgSquareClass={pfData[1].bgSquareClass} />
                    <DescriptionMobile title={pfData[1].title} description={pfData[1].description} code={pfData[1].code} layout={pfData[1].layout} githubLink={pfData[1].liveLink} liveLink={pfData[1].liveLink} />
